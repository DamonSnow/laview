...
export const setExpiredIn = (expiredIn) => {
  Cookies.set(EXPIRED_IN, expiredIn, {expires: config.cookieExpires || 1})
}
...
export const getExpiredIn = () => {
  const expiredIn = Cookies.get(EXPIRED_IN)
  if (expiredIn) return expiredIn
  else return false
}
...
export const isTokenExpired = () => {
  ...
  return stamp < 60 * config.expiredIn;
}
